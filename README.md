...
This is a sample template for my-cool-app - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name my-cool-app --query 'Stacks[].Outputs'
```
